...
- [**Does my research generate scientific data?**](#scientific-data) If yes, you will need to submit a DMS Plan.
- [**When do I need to share my data?**](#sharing-timeline)
- [**Can I elect to not share data?**](#choose-to-not-share) The short answer is yes. However, you must still justify this choice in a submitted DMS Plan.
