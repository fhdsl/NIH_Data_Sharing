...
```{r, echo=FALSE, fig.alt='DMS plans can be edited during the Just In Time process or during regular reporting intervals, so it's okay if you need to make changes when you learn of better alternatives.', out.width = '100%'}
