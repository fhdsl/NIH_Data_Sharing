...
```{r, echo=FALSE, fig.alt='Researchers with scientific data must justify why they won't share data with an appropriate exception.', out.width = '70%', fig.align = 'center'}
