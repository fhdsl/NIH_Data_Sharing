...
- more transparency/reproduciblity/validation
...
3. When compliance is required (bit confused about Ts and Fs - I think they are saying don't need to only when they don't generate data, but they definitely often do)
...
5. Reasons why you might not share your data
 - legal/ethical/technical (I think being too large to be cost prohibative is possible)
 examples 
...
6. DSM elements
   ...
   - Initially not public now.. but may in the future (so don't include anything confidential or proprietary)
    ...
    4. data preservation, access, timelines
      ...
      - renewals can have updated DSM plan with a different timeline, but if not approved must use previous DSM date
...
- otherplans field added to forms H filed of the PHS 398 research plan form/career development supplemental form
