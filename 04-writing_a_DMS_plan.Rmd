...
- _If indeed the data requires compliance with the Genomic Data Sharing Policy, researchers should indicate if the study should be designated as ["sensitive"](https://grants.nih.gov/grants/guide/notice-files/NOT-OD-19-023.html)._
...
- _If data cannot be shared due to an Institutional Certification criteria (for example, the data cannot be shared as expected by the GDS policy), researchers should include this information in their DMS plan and explain why the element cannot be met._
