...
```{r, echo=FALSE, fig.alt='When writing the plan, ensure it is less than 2 pages lnog, contains no confidential information, and has been planned out carefully, contacting the program officer if necessary.', out.width = '80%', fig.align = 'center'}
