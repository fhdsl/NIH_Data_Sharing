...
3. **Standards** - describe any standards that you might use for your data
...
List information about metadata, other possibly relevant data (that you think is not considered scientific), and any relevant information about how you plan to gather the data (ex. study protocols and data collection instruments) that you plan to share to make it easier for others to reproduce your work.
...
- this could include: data formats, data dictionaries, data identifiers, definitions, unique identifiers, and other data documentation
...
B. Methods to make scientific data findable and identifiable
 ...
 - describe what you will do to make the data more findable and identifiable. For example, perhaps using a persistent unique identifier or
